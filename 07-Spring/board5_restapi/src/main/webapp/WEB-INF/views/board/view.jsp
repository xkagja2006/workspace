...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
    ...
    */
    ...
    function makeCommentList(list){
    	...
    	for(let i = 0; i < list.length; i++){
    		...
    		<li>
    			...
    			<span><a href="#" onclick="commentDelete(\${comment.commentNo})">삭제</a></span>
    		</li>
    		`
    	}
    ...
    function commentDelete(commentNo) {
        ...
        fetch(`${root}/comment/${article.articleNo}/\${commentNo}`, config)		// 자바스크립트 문자열을 el로 받아들이지 않게 하기 위해 \을 추가한다. "~~" + commentNo 와 같은 역할.
          .then((response) => response.json())
          .then((data) => makeCommentList(data));
    }
